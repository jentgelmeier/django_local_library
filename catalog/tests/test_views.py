...
from django.contrib.auth.models import User, Permission # User required to assign User as a borrowe. Permission required to grant the permission needed to set a book as returned.
...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        # Get second page and confirm it has (exactly) remaning 3 items
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_book.genre.set(genre_objects_for_book) # Direct assignmore of many-to_many types not allowed.
        test_book.save()
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check our user is logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check that we got a resopnse "success"
        self.assertEqual(response.status_code, 200)
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        # Create genre as a post-step
        genre_objects_for_book = Genre.objects.all()
        test_book.genre.set(genre_objects_for_book) # Direcrt assignment of many-to-many types not allowed.
        test_book.save()
...
class AuthorCreateViewTest(TestCase):
    ...
    # Create users
        ...
        permission = Permission.objects.get(name='Create, update, or delete authors')
        test_user2.user_permissions.add(permission)
        test_user2.save()
